...
public class GetRecomendationByCityService implements Query<CityDTO, String> {
    ...
    public ResponseEntity<String> execute(CityDTO ciudad) {
        String prompt ="""
                Imagina que soy un turista en busca de lugares y eventos para mi visita a la ciudad de %s, que recomendaciones de lugares iconicos y locales me darias, formatea tu respuesta com oun breve parrafo platicado sin signos de puntuacion diferentes a comas y puntos
